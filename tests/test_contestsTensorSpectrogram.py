...
def test_analyzeComplexScaleInvariantSignalNoiseRatioMean(
	contestTensorSpectrogram: ContestTensorSpectrogram, expectedContest: float, approx_rel: float, approx_abs: float
) -> None:
...
def test_analyzeSpectralConvergenceLossMean(
	contestTensorSpectrogramMagnitude: ContestTensorSpectrogramMagnitude, expectedContest: float, approx_rel: float, approx_abs: float
) -> None:
