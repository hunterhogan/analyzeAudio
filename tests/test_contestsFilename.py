...
def _standardizedEqualScalars(
	analyzer: str, pathFilenamesContest: ContestFilenames, actual: float, expected: float, K: float | None = None
) -> None:
	parameters = (
...
def test_analyzePSNRmean(pathFilenamesContest: ContestFilenames, expectedContestFilename: float) -> None:
...
def test_analyzeSDRmean(pathFilenamesContest: ContestFilenames, expectedContestFilename: float) -> None:
...
def test_analyzeSI_SDRmean(pathFilenamesContest: ContestFilenames, expectedContestFilename: float) -> None:
...
def test_analyzePSNRmeanK(pathFilenamesContest: ContestFilenames, K: float, expectedContestFilename: float) -> None:
...
def test_analyzeSDRmeanK(pathFilenamesContest: ContestFilenames, K: float, expectedContestFilename: float) -> None:
...
def test_analyzeSI_SDRmeanK(pathFilenamesContest: ContestFilenames, K: float, expectedContestFilename: float) -> None:
