...
def test_analyzeSpectralContrastMean_returns_registered_float(
	...
	arraySpectrogramMagnitude, _arraySpectrogramPowerUnused, _sampleRateUnused = spectrogramFeatureCase
	valueSpectralContrastMean = analyzersUseSpectrogram.analyzeSpectralContrastMean(arraySpectrogramMagnitude, **dictionaryKeywordArguments)
...
def test_analyzeSpectralBandwidthMean_returns_registered_float(
	...
	valueSpectralBandwidthMean = analyzersUseSpectrogram.analyzeSpectralBandwidthMean(
		arraySpectrogramMagnitude, **dictionaryKeywordArguments
	)
...
def test_analyzeSpectralCentroidMean_returns_registered_float(
	...
	arraySpectrogramMagnitude, arraySpectrogramPowerUnused, sampleRateUnused = spectrogramFeatureCase
	valueSpectralCentroidMean = analyzersUseSpectrogram.analyzeSpectralCentroidMean(arraySpectrogramMagnitude, **dictionaryKeywordArguments)
...
def test_analyzeSpectralFlatnessMean_returns_registered_float(
	...
	arraySpectrogramMagnitude, arraySpectrogramPowerUnused, sampleRateUnused = spectrogramFeatureCase
	valueSpectralFlatnessMean = analyzersUseSpectrogram.analyzeSpectralFlatnessMean(arraySpectrogramMagnitude, **dictionaryKeywordArguments)
