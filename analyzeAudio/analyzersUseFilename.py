...
def getSI_SDRmean(pathFilenameAlpha: str | os.PathLike[Any], pathFilenameBeta: str | os.PathLike[Any]) -> float | None:
	"""
...
def ffprobeShotgunAndCache(pathFilename: str | os.PathLike[Any]) -> dict[str, float]:
