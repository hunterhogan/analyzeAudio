...
if __name__ == "__main__":
	...
	lPFn: list[pathlib.Path] = (list(pathlib.Path("/apps/analyzeAudio/tests/dataSamples").rglob("ch2_44100_09s_LUFS20_birdsPink*.wav")))
	...
	singleTargetFloats: list[str] = ['Abs_Peak_count total', 'Bit_depth mean', 'Chromagram mean', 'Crest_factor mean', 'DC_offset mean', 'Dynamic_range overall', 'Entropy mean', 'Flat_factor mean', 'LUFS high', 'LUFS integrated', 'LUFS loudness range', 'LUFS low', 'LUFS momentary maximum', 'LUFS short-term maximum', 'Max_difference overall', 'Max_level overall', 'Mean_difference mean', 'Min_difference overall', 'Min_level overall', 'Noise_floor overall', 'Noise_floor_count total', 'Number_of_samples total', 'Peak_count total', 'Peak_level overall', 'Power spectral density mean', 'RMS from waveform mean', 'RMS_difference overall', 'RMS_level overall', 'RMS_peak overall', 'RMS_trough overall', 'SRMR mean', 'Spectral Bandwidth mean', 'Spectral Centroid mean', 'Spectral Contrast mean', 'Spectral Flatness mean', 'Spectral centroid mean', 'Spectral crest mean', 'Spectral decrease mean', 'Spectral entropy mean', 'Spectral flatness mean', 'Spectral flux mean', 'Spectral kurtosis mean', 'Spectral rolloff mean', 'Spectral skewness mean', 'Spectral slope mean', 'Spectral spread mean', 'Spectral variance mean', 'Tempo mean', 'Tempogram mean', 'Zero-crossing rate mean', 'Zero_crossings total', 'Zero_crossings_rate overall', 'true_peak maximum']
